...
const aboutMeSection = document.querySelector('section.about-me') as HTMLElement;
const skillsSection = document.querySelector('section.skills') as HTMLElement;
const projectsSection = document.querySelector('section.projects') as HTMLElement;
const contactMeSection = document.querySelector('section.contact-me') as HTMLElement;
...
const titleView = document.querySelector('header .title') as HTMLParagraphElement;
const titleCursor = document.querySelector('header .title .cursor') as HTMLSpanElement;
const siteVisitsView = document.querySelector('header .web-visits') as HTMLParagraphElement;
const siteVisitsCursor = document.querySelector('header .web-visits .cursor') as HTMLSpanElement;

const fastForward = document.querySelector('.fast-forward') as HTMLButtonElement;
const downBtn = document.querySelector('.down') as HTMLButtonElement;
const upBtn = document.querySelector('.up') as HTMLButtonElement;

const aboutMeSecBtns = document.querySelectorAll('button.about-me') as NodeListOf<HTMLButtonElement>;
const skillsSecBtns = document.querySelectorAll('button.skills') as NodeListOf<HTMLButtonElement>;
const projectsSecBtns = document.querySelectorAll('button.projects') as NodeListOf<HTMLButtonElement>;
const contactMeSecBtns = document.querySelectorAll('button.contact-me') as NodeListOf<HTMLButtonElement>;

const dropdownBtn = document.querySelector('button.dropdown') as HTMLButtonElement;
const dropdownDiv = document.querySelector('.dropdown.mobile') as HTMLDivElement;

const galleryImages = document.querySelectorAll('.image-selector img') as NodeListOf<HTMLImageElement>;
const galleryDescriptions = document.querySelectorAll('.image-info .description p') as NodeListOf<HTMLParagraphElement>;
const galleryIndexView = document.querySelector('.image-info .pagination') as HTMLHeadingElement;
const galleryPrev = document.querySelector('.image-info .prev') as HTMLButtonElement;
const galleryNext = document.querySelector('.image-info .next') as HTMLButtonElement;

const nameDiv = document.querySelector('form .first-name') as HTMLDivElement;
const nameInput = document.querySelector('form .first-name input') as HTMLInputElement;
const emailDiv = document.querySelector('form .email') as HTMLDivElement;
const emailInput = document.querySelector('form .email input') as HTMLInputElement;
...
async function animHeaderTitle() {
    setTimeout(async () => {
        ...
        await typeText(titleView.childNodes[0] as Text, titles[titleIndex], titleCursor as Element);
        animHeaderTitle();
    }, 5000);
}
